...
```
┌─────────────────────────────────────────────────────────┐
│ Pipeline Builder | Pipeline Name: [MyPipeline]          │
├─────────────────────────────────────────────────────────┤
│                                                          │
│ Pipeline Parameters       │  DAG Canvas    │  Node Edit  │
│ ├─ init_path             │                 │ Args:       │
│ ├─ image_pattern         │  [node] → [*]   │ [inputs]    │
│ ├─ warning_up_rate       │   ↓     ↓       │             │
│                          │ [node] [node]   │ Output:     │
│ Components              │   ↓       ↓     │ [dropdown]  │
│ ├─ Blank Component      │  [node]         │             │
│                          │                 │ Description │
│ Nodes                    │                 │ [text]      │
│ ├─ inference_image      │                 │             │
│ ├─ model_training       │                 │             │
